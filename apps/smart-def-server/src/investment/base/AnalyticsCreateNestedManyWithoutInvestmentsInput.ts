...
@InputType()
class AnalyticsCreateNestedManyWithoutInvestmentsInput {
...
export { AnalyticsCreateNestedManyWithoutInvestmentsInput as AnalyticsCreateNestedManyWithoutInvestmentsInput };
